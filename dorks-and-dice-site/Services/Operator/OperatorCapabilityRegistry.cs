...
public sealed class OperatorCapabilityRegistry : IOperatorCapabilityRegistry
{
    ...
    [
        ...
        new("operator.capabilities", "GET", "/operator/v1/capabilities", "Discover framework-owned Site machine capabilities.", ResponseSchema: "OperatorCapabilitiesResponse"),
        new("operator.browser_bootstrap", "POST", "/operator/v1/browser-bootstrap", "Issue a short-lived one-use token that establishes a normal Site browser session.", ResponseSchema: "OperatorBrowserBootstrapResponse"),
